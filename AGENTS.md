...
- No virtual environment or dependency file (`requirements.txt`, `pyproject.toml`) exists yet. When one is added, the update script should be updated accordingly.
